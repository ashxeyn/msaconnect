...
<table id="netEarningsTable">
    ...
    <div id="cashInModal" class="modal">
        <div class="modal-content">
            <h3>Manage Cash-In</h3>
            <input type="hidden" id="cashInRowIndex">
            <label>Month:</label>
            <input type="month" id="cashInMonth">
            <label>Amount:</label>
            <input type="text" id="cashInAmount">
            <button id="saveCashIn">Save</button>
        </div>
    </div>
    ...
    <div id="cashOutModal" class="modal">
        <div class="modal-content">
            <h3>Manage Cash-Out</h3>
            <input type="hidden" id="cashOutRowIndex">
            <label>Date:</label>
            <input type="date" id="cashOutDate">
            <label>Expense Detail:</label>
            <input type="text" id="cashOutDetail">
            <label>Category:</label>
            <input type="text" id="cashOutCategory">
            <label>Amount:</label>
            <input type="text" id="cashOutAmount">
            <button id="saveCashOut">Save</button>
        </div>
    </div>
